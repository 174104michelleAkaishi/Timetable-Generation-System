...
public class Timetable {
    ...
    public void displayAllTimeSlotsUsingDatabase(){
     ...
     public void displayTimetableStudentwise(String insID)
    {
         try{ 
             ...
             this.timetablestmt = (Statement) this.timtableCon.createStatement(); 
             try{
                String s = "select * from Student where rollNumber=?";
     ...
     public void displayTimetableStudentwiseONGUI(String insID,javax.swing.JTextArea jTextArea1)
    {
         try{ 
             ArrayList <String> course = new ArrayList <String>() ;
             ArrayList <String> sec = new ArrayList <String>() ;
